...
; CHECK: %[[intTy:[0-9]+]] = OpTypeInt 32
; CHECK: %[[bits:[0-9]+]] = OpFunctionParameter %[[intTy]]
; CHECK: %[[bits2:[0-9]+]] = OpFunctionParameter %[[intTy]]
; CHECK: %[[bits3:[0-9]+]] = OpFunctionParameter %[[intTy]]

; CHECK: %{{[0-9]+}} = OpBitReverse %[[intTy]] %[[bits2]]
